...
const ARCHAI_PUBLIC_PRICING = {
  personal: { implementation: "от 50 000 ₽", support: "от 24 900 ₽/мес после запуска" },
  expanded: { implementation: "от 90 000 ₽", support: "по составу проекта" },
  business: { implementation: "от 120 000 ₽", support: "от 24 900 ₽/мес" },
  administrator: { implementation: "от 120 000 ₽", support: "от 24 900 ₽/мес" },
  service: { implementation: "от 120 000 ₽", support: "от 24 900 ₽/мес" },
  seller: { implementation: "от 150 000 ₽", support: "от 24 900 ₽/мес" },
  office: { implementation: "от 350 000 ₽", support: "от 24 900 ₽/мес" },
  exampleAdministrator: { implementation: "от 160 000 ₽", support: "от 24 900 ₽/мес" },
  exampleSeller: { implementation: "от 190 000 ₽", support: "от 24 900 ₽/мес" },
  exampleOffice: { implementation: "от 450 000 ₽", support: "от 24 900 ₽/мес" },
  text: { included: "входит в сопровождение от 24 900 ₽/мес" },
  tts: { included: "входят в сопровождение от 24 900 ₽/мес" },
