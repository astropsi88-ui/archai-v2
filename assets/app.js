...
const schemaNotes={memory:'Супербаза — живая память о людях, событиях, разговорах, проектах и накопленном опыте.',character:'Характер — сохраняет узнаваемую манеру общения, ритм, привычки и отношение к владельцу.',infra:'Мозг — AI-модель, которая думает, анализирует, пишет, видит и использует инструменты. Её можно обновлять.',server:'Сервер — личное пространство, где работают память, подключения и выбранные открытые системы.',backup:'Капсула — сохраняет характер, ключевые знания, важную память и общую историю для продолжения.',connection:'Связь — позволяет личности присутствовать в Telegram, на сайте и в других выбранных средах.',abilities:'Способности — почта, календарь, документы, поиск, изображения, видео и другие нужные действия.',ownership:'Собственность — основа личности, память, материалы и настройки могут быть переданы владельцу.'};
