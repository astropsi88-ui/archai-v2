...
const typingText='Напишите Вику своими словами, кого вы хотите создать…';
...
window.addEventListener('DOMContentLoaded',()=>{updateSchemaGeometry();sizeVikMessage()});window.addEventListener('resize',updateSchemaGeometry);window.addEventListener('orientationchange',()=>setTimeout(updateSchemaGeometry,120));if(document.readyState!=='loading'){updateSchemaGeometry();sizeVikMessage()}
